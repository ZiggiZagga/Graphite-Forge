...
/**
 * CORS configuration for GraphQL service.
 *
 * <p>Configures Cross-Origin Resource Sharing for the GraphQL API,
 * allowing frontend applications from authorized origins to access the API.</p>
 */
@Configuration
