...
/**
 * Test suite for PolicyEditor component (Admin UI)
 * Tests policy management with dry-run and validation
 */
describe('PolicyEditor Component', () => {
  ...
  describe('Dry-Run Functionality', () => {
    it('should test policy before saving', async () => {
      ...
      const dryRunButton = screen.getByText(/test policy/i)
  ...
  describe('Admin-Only Access', () => {
    it('should not render for non-admin users', () => {
      const mockUserClaims = { roles: ['user'] }
    ...
    it('should render for admin users', () => {
      const mockUserClaims = { roles: ['admin'] }
      jest.mock('@/hooks/useUserClaims', () => ({
        useUserClaims: () => mockUserClaims
      }))
